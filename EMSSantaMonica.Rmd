...
```{r risk factor maps, message=FALSE, warning=FALSE, results='hide', fig.height=8, fig.width=4}
#select features
...
```{r calls / time of day, fig.height=4, fig.width=8, message=FALSE, warning=FALSE, results='hide'}
grid.arrange(
