...
), year=2018, state=06, county=037, geometry=T) %>%
...
ggplot() +
  ...
  labs(title = "Figure 2: Observed EMS Incidents Joined to Fishnet, 2019", subtitle = "Santa Monica, CA") +
  mapTheme()
...
final_net <-
  left_join(EMS_net, st_drop_geometry(vars_net), by="uniqueID") 
